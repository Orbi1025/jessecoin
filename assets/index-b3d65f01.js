import {
  ...
  O as Z,
  c as ht,
} from "./index-400a3491.js";
import { q as Wr } from "./index-29f8386e.js";
/**
 * @license
 ...
 */ const re = window,
  mo =
    re.ShadowRoot &&
    (re.ShadyCSS === void 0 || re.ShadyCSS.nativeShadow) &&
...
const Ur = (e) => new Jo(typeof e == "string" ? e : e + "", void 0, fo),
  I = (e, ...t) => {
    const o =
      e.length === 1
        ? e[0]
    ...
    return new Jo(o, e, fo);
  },
  jr = (e, t) => {
    mo
      ? (e.adoptedStyleSheets = t.map((o) =>
...
const ne = window,
  Po = ne.trustedTypes,
  kr = Po ? Po.emptyScript : "",
  Io = ne.reactiveElementPolyfillSupport,
  ke = {
    toAttribute(e, t) {
      switch (t) {
        case Boolean:
...
let wt = class extends HTMLElement {
  ...
  static addInitializer(t) {
    var o;
    this.finalize(),
      ((o = this.h) !== null && o !== void 0 ? o : (this.h = [])).push(t);
  }
  static get observedAttributes() {
    this.finalize();
    const t = [];
    return (
      this.elementProperties.forEach((o, n) => {
        const r = this._$Ep(n, o);
        r !== void 0 && (this._$Ev.set(r, n), t.push(r));
      }),
      t
    );
  }
  static createProperty(t, o = Ce) {
    if (
      (o.state && (o.attribute = !1),
      this.finalize(),
      this.elementProperties.set(t, o),
      !o.noAccessor && !this.prototype.hasOwnProperty(t))
    ) {
      const n = typeof t == "symbol" ? Symbol() : "__" + t,
        r = this.getPropertyDescriptor(t, n, o);
      r !== void 0 && Object.defineProperty(this.prototype, t, r);
    }
  }
  static getPropertyDescriptor(t, o, n) {
    return {
      get() {
        return this[o];
      },
      set(r) {
        const i = this[t];
        (this[o] = r), this.requestUpdate(t, i, n);
      },
      configurable: !0,
      enumerable: !0,
    };
  ...
  static finalize() {
    ...
    if (
      ...
      for (const r of n) this.createProperty(r, o[r]);
    }
  ...
  static finalizeStyles(t) {
    ...
    if (Array.isArray(t)) {
      ...
      for (const r of n) o.unshift(Oo(r));
    } else t !== void 0 && o.push(Oo(t));
    return o;
  }
  static _$Ep(t, o) {
    const n = o.attribute;
  ...
  _$Eu() {
    var t;
    (this._$E_ = new Promise((o) => (this.enableUpdating = o))),
      (this._$AL = new Map()),
      this._$Eg(),
      this.requestUpdate(),
  ...
  addController(t) {
    var o, n;
    ((o = this._$ES) !== null && o !== void 0 ? o : (this._$ES = [])).push(t),
  ...
  removeController(t) {
    ...
    (o = this._$ES) === null ||
      o === void 0 ||
      o.splice(this._$ES.indexOf(t) >>> 0, 1);
  }
  _$Eg() {
    this.constructor.elementProperties.forEach((t, o) => {
  ...
  createRenderRoot() {
    ...
    return jr(o, this.constructor.elementStyles), o;
  }
  connectedCallback() {
    var t;
    this.renderRoot === void 0 && (this.renderRoot = this.createRenderRoot()),
      ...
      (t = this._$ES) === null ||
        ...
        t.forEach((o) => {
          var n;
          return (n = o.hostConnected) === null || n === void 0
            ? void 0
            : n.call(o);
        });
  }
  ...
  disconnectedCallback() {
    ...
    (t = this._$ES) === null ||
      ...
      t.forEach((o) => {
        var n;
        return (n = o.hostDisconnected) === null || n === void 0
          ? void 0
          : n.call(o);
      });
  }
      ...
      const s = r.getPropertyOptions(i),
        l =
          typeof s.converter == "function"
            ...
            : ke;
      (this._$El = i),
        (this[i] = l.fromAttribute(o, s.type)),
        (this._$El = null);
    }
  }
  requestUpdate(t, o, n) {
    let r = !0;
    t !== void 0 &&
      (((n = n || this.constructor.getPropertyOptions(t)).hasChanged || Qo)(
        this[t],
        o
      )
        ? (this._$AL.has(t) || this._$AL.set(t, o),
          n.reflect === !0 &&
            this._$El !== t &&
  ...
  performUpdate() {
    ...
    this.hasUpdated,
      this._$Ei &&
        (this._$Ei.forEach((r, i) => (this[i] = r)), (this._$Ei = void 0));
    let o = !1;
    const n = this._$AL;
    try {
      (o = this.shouldUpdate(n)),
        o
          ? (this.willUpdate(n),
            (t = this._$ES) === null ||
              t === void 0 ||
              t.forEach((r) => {
                var i;
                return (i = r.hostUpdate) === null || i === void 0
                  ? void 0
                  : i.call(r);
              }),
            this.update(n))
  ...
  _$AE(t) {
    ...
    (o = this._$ES) === null ||
      ...
      o.forEach((n) => {
        var r;
        return (r = n.hostUpdated) === null || r === void 0
          ? void 0
          : r.call(n);
      }),
  ...
  update(t) {
    this._$EC !== void 0 &&
      (this._$EC.forEach((o, n) => this._$EO(n, this[n], o)),
      (this._$EC = void 0)),
      this._$Ek();
  }
  updated(t) {}
...
const ie = window,
  xt = ie.trustedTypes,
  To = xt ? xt.createPolicy("lit-html", { createHTML: (e) => e }) : void 0,
  ze = "$lit$",
  ...
  tr = Array.isArray,
  zr = (e) =>
    tr(e) || typeof (e == null ? void 0 : e[Symbol.iterator]) == "function",
  Ae = `[ 	
\f\r]`,
  ...
  for (let l = 0; l < o; l++) {
      ...
      (h = s.lastIndex),
        s === Dt
          ? d[1] === "!--"
            ...
            ? (s = So)
            : d[2] !== void 0
            ? (er.test(d[2]) && (r = RegExp("</" + d[2], "g")), (s = at))
            : d[3] !== void 0 && (s = at)
          : s === at
          ? d[0] === ">"
            ? ((s = r ?? Dt), (y = -1))
            : d[1] === void 0
            ? (y = -2)
            : ((y = s.lastIndex - d[2].length),
              (c = d[1]),
              (s = d[3] === void 0 ? at : d[3] === '"' ? Do : Ro))
          : s === Do || s === Ro
          ? (s = at)
          : s === Mo || s === So
          ? (s = Dt)
    ...
    i +=
      s === Dt
        ? a + Hr
        : y >= 0
        ? (n.push(c), a.slice(0, y) + ze + a.slice(y) + Q + p)
        : a + Q + (y === -2 ? (n.push(void 0), l) : p);
  }
  return [rr(e, i + (e[o] || "<?>") + (t === 2 ? "</svg>" : "")), n];
};
class jt {
  constructor({ strings: t, _$litType$: o }, n) {
    ...
    if (
      ...
      const y = this.el.content,
        h = y.firstChild;
      h.remove(), y.append(...h.childNodes);
    }
    for (; (r = ct.nextNode()) !== null && a.length < l; ) {
      if (r.nodeType === 1) {
        if (r.hasAttributes()) {
          const y = [];
          for (const h of r.getAttributeNames())
            if (h.endsWith(ze) || h.startsWith(Q)) {
              const p = d[s++];
              if ((y.push(h), p !== void 0)) {
                const g = r.getAttribute(p.toLowerCase() + ze).split(Q),
                  f = /([.?@])?(.*)/.exec(p);
                a.push({
                  type: 1,
                  index: i,
          ...
          for (const h of y) r.removeAttribute(h);
        }
        if (er.test(r.tagName)) {
          const y = r.textContent.split(Q),
            h = y.length - 1;
          if (h > 0) {
            r.textContent = xt ? xt.emptyScript : "";
            for (let p = 0; p < h; p++)
              r.append(y[p], Wt()),
                ct.nextNode(),
        ...
        if (r.data === Xo) a.push({ type: 2, index: i });
        else {
          let y = -1;
          for (; (y = r.data.indexOf(Q, y + 1)) !== -1; )
            a.push({ type: 7, index: i }), (y += Q.length - 1);
        }
      i++;
    }
  }
...
function _t(e, t, o = e, n) {
  var r, i, s, l;
  if (t === mt) return t;
  let a =
    n !== void 0
      ? (r = o._$Co) === null || r === void 0
        ? void 0
        : r[n]
      : o._$Cl;
  ...
  return (
    (a == null ? void 0 : a.constructor) !== c &&
      ((i = a == null ? void 0 : a._$AO) === null ||
        i === void 0 ||
        i.call(a, !1),
      c === void 0 ? (a = void 0) : ((a = new c(e)), a._$AT(e, o, n)),
      n !== void 0
        ? (((s = (l = o)._$Co) !== null && s !== void 0 ? s : (l._$Co = []))[
            n
          ] = a)
        : (o._$Cl = a)),
...
class Vr {
  ...
  u(t) {
    ...
    const {
      ...
      i = (
        (o = t == null ? void 0 : t.creationScope) !== null && o !== void 0
          ? o
          : ut
      ).importNode(n, !0);
    ct.currentNode = i;
    ...
    for (; c !== void 0; ) {
      if (l === c.index) {
        let d;
        c.type === 2
          ? (d = new Kt(s, s.nextSibling, this, t))
          : c.type === 1
          ? (d = new c.ctor(s, c.name, c.strings, this, t))
          : c.type === 6 && (d = new Gr(s, this, t)),
          this._$AV.push(d),
          (c = r[++a]);
      }
  ...
  v(t) {
    ...
    for (const n of this._$AV)
      n !== void 0 &&
        (n.strings !== void 0
          ? (n._$AI(t, n, o), (o += n.strings.length - 2))
          : n._$AI(t[o])),
        o++;
  }
}
class Kt {
  constructor(t, o, n, r) {
    ...
    (this.type = 2),
      ...
      (this.options = r),
      (this._$Cp =
        (i = r == null ? void 0 : r.isConnected) === null || i === void 0 || i);
  }
  get _$AU() {
    var t, o;
    return (o = (t = this._$AM) === null || t === void 0 ? void 0 : t._$AU) !==
      null && o !== void 0
      ? o
      : this._$Cp;
  }
    ...
    const { values: n, _$litType$: r } = t,
      i =
        typeof r == "number"
          ? this._$AC(t)
          : (r.el === void 0 &&
              (r.el = jt.createElement(rr(r.h, r.h[0]), this.options)),
            r);
    if (((o = this._$AH) === null || o === void 0 ? void 0 : o._$AD) === i)
      this._$AH.v(n);
    else {
      const s = new Vr(i, this),
        l = s.u(this.options);
      s.v(n), this.$(l), (this._$AH = s);
    }
  }
  _$AC(t) {
    let o = Lo.get(t.strings);
    return o === void 0 && Lo.set(t.strings, (o = new jt(t))), o;
  }
  T(t) {
    ...
    for (const i of t)
      r === o.length
        ? o.push((n = new Kt(this.k(Wt()), this.k(Wt()), this, this.options)))
        : (n = o[r]),
        n._$AI(i),
        r++;
    r < o.length && (this._$AR(n && n._$AB.nextSibling, r), (o.length = r));
  }
  _$AR(t = this._$AA.nextSibling, o) {
    var n;
    for (
      (n = this._$AP) === null || n === void 0 || n.call(this, !1, !0, o);
      t && t !== this._$AB;
  ...
  setConnected(t) {
    ...
    this._$AM === void 0 &&
      ((this._$Cp = t),
      (o = this._$AP) === null || o === void 0 || o.call(this, t));
  }
}
class ge {
...
class Yr extends ge {
  constructor(t, o, n, r, i) {
    super(t, o, n, r, i), (this.type = 5);
  }
  _$AI(t, o = this) {
    var n;
    if ((t = (n = _t(this, t, o, 0)) !== null && n !== void 0 ? n : B) === mt)
      return;
    const r = this._$AH,
      i =
        (t === B && r !== B) ||
...
const No = ie.litHtmlPolyfillSupport;
No == null || No(jt, Kt),
...
const Jr = (e, t, o) => {
  var n, r;
  const i =
    (n = o == null ? void 0 : o.renderBefore) !== null && n !== void 0 ? n : t;
  let s = i._$litPart$;
  if (s === void 0) {
    const l =
      (r = o == null ? void 0 : o.renderBefore) !== null && r !== void 0
        ? r
        : null;
    i._$litPart$ = s = new Kt(t.insertBefore(Wt(), l), l, void 0, o ?? {});
  }
  return s._$AI(e), s;
};
/**
...
class E extends wt {
  ...
  createRenderRoot() {
    ...
    return (
      ((t = (o = this.renderOptions).renderBefore) !== null && t !== void 0) ||
        (o.renderBefore = n.firstChild),
      n
    );
  }
  update(t) {
    ...
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected),
      super.update(t),
      (this._$Do = Jr(o, this.renderRoot, this.renderOptions));
  }
  connectedCallback() {
    var t;
...
function _(e) {
  return (t, o) => (o !== void 0 ? Xr(e, t, o) : Qr(e, t));
}
/**
 * @license
 * Copyright 2017 Google LLC
    ...
    update(e, [t]) {
      ...
      for (const i in t) {
        ...
        s === this.it.has(i) ||
          ...
          (s ? (r.add(i), this.it.add(i)) : (r.remove(i), this.it.delete(i)));
      }
      return mt;
    }
  }
...
const nr = (e, t, o) => Math.min(Math.max(o, e), t),
...
const ir = (e, t, o) => -o * e + o * t + e,
  sr = () => {},
  et = (e) => e,
  po = (e, t, o) => (t - e === 0 ? 1 : (o - e) / (t - e));
function lr(e, t) {
...
function an(e, t = ln(e.length), o = et) {
  const n = e.length,
    r = n - t.length;
  return (
    r > 0 && lr(t, r),
    (i) => {
      let s = 0;
      for (; s < n - 2 && !(i < t[s + 1]); s++);
      let l = nr(0, 1, po(t[s], t[s + 1], i));
      return (l = sn(o, s)(l)), ir(e[s], e[s + 1], l);
    }
  );
}
const ar = (e) => Array.isArray(e) && se(e[0]),
...
function un(e, t, o, n, r) {
  let i,
    s,
    l = 0;
  do (s = t + (o - t) / 2), (i = cr(s, n, r) - e), i > 0 ? (o = s) : (t = s);
  while (Math.abs(i) > dn && ++l < hn);
  return s;
}
function Lt(e, t, o, n) {
  if (e === t && o === n) return et;
  const r = (i) => un(i, 0, 1, e, o);
  return (i) => (i === 0 || i === 1 ? i : cr(r(i), t, n));
}
const mn =
    (e, t = "end") =>
    (o) => {
...
class dr {
  constructor(
    ...
    if (
      ...
      const h = n.createAnimation(o);
      (n = h.easing), (o = h.keyframes || o), (r = h.duration || r);
    }
    (this.repeat = l),
      (this.easing = bt(n) ? et : Wo(n)),
      this.updateDuration(r);
    const y = an(o, a, bt(n) ? n.map(Wo) : et);
    (this.tick = (h) => {
      var p;
      i = i;
      let g = 0;
      ...
      (c === "reverse" ||
        (c === "alternate" && b) ||
        (c === "alternate-reverse" && !b)) &&
        (m = 1 - m);
      const w = g >= this.totalDuration ? 1 : Math.min(m, 1),
        v = y(this.easing(w));
      t(v),
        this.pauseTime === void 0 &&
...
function wn(e, t) {
  return e.has(t) || e.set(t, new gn()), e.get(t);
}
const vn = ["", "X", "Y", "Z"],
...
bn.forEach((e) => {
  vn.forEach((t) => {
    ae.push(e + t), kt.set(go(e + t), yn[e]);
  });
});
const $n = (e, t) => ae.indexOf(e) - ae.indexOf(t),
  ...
  _n = (e, t) => {
    le[t] && (t = le[t]);
    const { transforms: o } = hr(e);
    rn(o, t), (e.style.transform = Cn(o));
  },
  Cn = (e) => e.sort($n).reduce(En, "").trim(),
  En = (e, t) => `${e} ${t}(var(${go(t)}))`,
  Ve = (e) => e.startsWith("--"),
  jo = new Set();
function An(e) {
  if (!jo.has(e)) {
    jo.add(e);
    try {
      const { syntax: t, initialValue: o } = kt.has(e) ? kt.get(e) : {};
...
const Me = (e, t) => document.createElement("div").animate(e, t),
  ...
  vt = {};
for (const e in ko)
  vt[e] = () => (Se[e] === void 0 && (Se[e] = ko[e]()), Se[e]);
const On = 0.015,
  Pn = (e, t) => {
    let o = "";
    const n = Math.round(t / On);
    for (let r = 0; r < n; r++) o += e(po(0, n - 1, r)) + ", ";
  ...
  Ho = (e, t) =>
    Ct(e)
      ...
      ? In(e)
      : e,
  In = ([e, t, o, n]) => `cubic-bezier(${e}, ${t}, ${o}, ${n})`;
function Tn(e, t) {
...
function Ze(e) {
  return le[e] && (e = le[e]), ur(e) ? go(e) : e;
}
const Xt = {
  get: (e, t) => {
    t = Ze(t);
    let o = Ve(t) ? e.style.getPropertyValue(t) : getComputedStyle(e)[t];
    if (!o && o !== 0) {
      const n = kt.get(t);
      n && (o = n.initialValue);
    }
  ...
  set: (e, t, o) => {
    (t = Ze(t)), Ve(t) ? e.style.setProperty(t, o) : (e.style[t] = o);
  },
};
function mr(e, t = !0) {
...
function Dn(e, t, o, n = {}, r) {
  ...
  const C = Ze(t),
    ...
    R = kt.get(C);
  return (
    mr(S.animation, !(Fe(h) && S.generator) && n.record !== !1),
    () => {
      const U = () => {
        var D, Y;
        return (Y =
      ...
      if (
        (Ve(C) && (vt.cssRegisterProperty() ? An(C) : (v = !1)),
        ...
        (l = e.animate(
          {
            [C]: M,
            offset: f,
            easing: bt(h) ? h.map((W) => Ho(W, a)) : void 0,
          },
          D
        )),
          l.finished ||
            (l.finished = new Promise((W, Nr) => {
              (l.onfinish = W), (l.oncancel = Nr);
            }));
      ...
      return (
        s &&
          i(
            ...
            t,
            M,
            { duration: a, delay: c, easing: h, repeat: y, offset: f },
            "motion-one"
          ),
        S.setAnimation(l),
        l && !m && l.pause(),
...
const Bn = (e) => e(),
  fr = (e, t, o = V.duration) =>
    new Proxy(
      { animations: e.map(Bn).filter(Boolean), duration: o, options: t },
      Un
    ),
  Wn = (e) => e.animations[0],
  Un = {
    get: (e, t) => {
      ...
      switch (t) {
        case "duration":
          return e.duration;
        case "currentTime":
          return Nt.s((o == null ? void 0 : o[t]) || 0);
        case "playbackRate":
        case "playState":
        ...
        case "finished":
          return (
            e.finished ||
              (e.finished = Promise.all(e.animations.map(jn)).catch(sr)),
            e.finished
          );
        case "stop":
          return () => {
            e.animations.forEach((n) => mr(n));
          };
        case "forEachNative":
          return (n) => {
...
function Hn(e) {
  return function (o, n, r = {}) {
    ...
    for (let l = 0; l < i; l++) {
      ...
      for (const c in n) {
        const d = Ln(r, c);
        d.delay = kn(d.delay, l, i);
        const y = Dn(a, c, n[c], d, e);
        s.push(y);
      }
    }
    return fr(s, r, r.duration);
  };
}
const zn = Hn(dr);
function Fn(e, t = {}) {
...
Yt.prototype.set = function (e, t, o, n) {
...
Yt.prototype.xor = function (e, t, o) {
...
(function (e) {
  ...
  (e.getRowColCoords = function (n) {
    ...
    const r = Math.floor(n / 7) + 2,
      ...
      l = [i - 7];
    for (let a = 1; a < r - 1; a++) l[a] = l[a - 1] - s;
...
var vr = {};
const Yn = F.getSymbolSize,
  zo = 7;
vr.getPositions = function (t) {
  const o = Yn(t);
  return [
    [0, 0],
    [o - zo, 0],
...
(function (e) {
  ...
  (e.isValid = function (r) {
    ...
    (e.getPenaltyN3 = function (r) {
      ...
      for (let c = 0; c < i; c++) {
        l = a = 0;
        for (let d = 0; d < i; d++)
          (l = ((l << 1) & 2047) | r.get(c, d)),
            d >= 10 && (l === 1488 || l === 93) && s++,
            (a = ((a << 1) & 2047) | r.get(d, c)),
            d >= 10 && (a === 1488 || a === 93) && s++;
      }
      return s * t.N3;
    }),
  ...
  (e.applyMask = function (r, i) {
    const s = i.size;
    for (let l = 0; l < s; l++)
      for (let a = 0; a < s; a++) i.isReserved(a, l) || i.xor(a, l, o(r, a, l));
  }),
...
ve.getBlocksCount = function (t, o) {
  switch (o) {
    case tt.L:
      return te[(t - 1) * 4 + 0];
    case tt.M:
...
ve.getTotalCodewordsCount = function (t, o) {
  switch (o) {
    case tt.L:
      return ee[(t - 1) * 4 + 0];
    case tt.M:
...
(function () {
  let t = 1;
  for (let o = 0; o < 255; o++)
    (Bt[o] = t), (ce[t] = o), (t <<= 1), t & 256 && (t ^= 285);
  for (let o = 255; o < 512; o++) Bt[o] = Bt[o - 255];
})();
be.log = function (t) {
...
(function (e) {
  ...
  (e.mul = function (n, r) {
    ...
    for (let s = 0; s < n.length; s++)
      for (let l = 0; l < r.length; l++) i[s + l] ^= t.mul(n[s], r[l]);
    return i;
  }),
    (e.mod = function (n, r) {
      ...
      for (; i.length - r.length >= 0; ) {
        const s = i[0];
        for (let a = 0; a < r.length; a++) i[a] ^= t.mul(r[a], s);
        let l = 0;
...
q.NUMERIC = new RegExp(_r, "g");
q.ALPHANUMERIC = new RegExp(Jn, "g");
const Xn = new RegExp("^" + Ht + "$"),
  ti = new RegExp("^" + _r + "$"),
  ei = new RegExp("^[A-Z0-9 $%*+\\-./:]+$");
...
(function (e) {
  ...
  function y(h, p) {
    for (let g = 1; g <= 40; g++)
      if (d(h, g) <= e.getCapacity(g, p, r.MIXED)) return g;
  }
  (e.from = function (p, g) {
    ...
    (e.getCapacity = function (p, g, f) {
      ...
      typeof f > "u" && (f = r.BYTE);
      const O = t.getSymbolTotalCodewords(p),
        m = o.getTotalCodewordsCount(p, g),
        b = (O - m) * 8;
      if (f === r.MIXED) return b;
      const w = b - c(f, p);
      switch (f) {
        case r.NUMERIC:
    ...
    (e.getBestVersionForData = function (p, g) {
      let f;
      const O = n.from(g, n.M);
      if (Array.isArray(p)) {
        if (p.length > 1) return y(p, O);
...
const Ke = F,
  Er = 1335,
  oi = 21522,
  Fo = Ke.getBCHDigit(Er);
Cr.getEncodedBits = function (t, o) {
  const n = (t.bit << 3) | o;
  let r = n << 10;
  for (; Ke.getBCHDigit(r) - Fo >= 0; ) r ^= Er << (Ke.getBCHDigit(r) - Fo);
  return ((n << 10) | r) ^ oi;
};
var Ar = {};
const ri = st;
...
At.prototype.write = function (t) {
  ...
  for (o = 0; o + 2 <= this.data.length; o += 2) {
    let n = Re.indexOf(this.data[o]) * 45;
    (n += Re.indexOf(this.data[o + 1])), t.put(n, 11);
  }
  this.data.length % 2 && t.put(Re.indexOf(this.data[o]), 6);
};
var si = At,
  li = function (t) {
...
(function (e) {
  ...
  function d(m, b, w) {
    ...
    let C;
    for (; (C = m.exec(w)) !== null; )
      v.push({ data: C[0], index: C.index, mode: b, length: C[0].length });
    return v;
  }
  function y(m) {
    const b = d(s.NUMERIC, t.NUMERIC, m),
      w = d(s.ALPHANUMERIC, t.ALPHANUMERIC, m);
    let v, C;
    return (
      l.isKanjiModeEnabled()
        ? ((v = d(s.BYTE, t.BYTE, m)), (C = d(s.KANJI, t.KANJI, m)))
        : ((v = d(s.BYTE_KANJI, t.BYTE, m)), (C = [])),
      b
        .concat(w, v, C)
        .sort(function (R, U) {
    ...
    for (let w = 0; w < m.length; w++) {
      ...
      switch (v.mode) {
        case t.NUMERIC:
          ...
          break;
        case t.ALPHANUMERIC:
          b.push([v, { data: v.data, mode: t.BYTE, length: v.length }]);
          break;
        case t.KANJI:
          b.push([v, { data: v.data, mode: t.BYTE, length: c(v.data) }]);
          break;
        case t.BYTE:
          b.push([{ data: v.data, mode: t.BYTE, length: c(v.data) }]);
      }
    }
    return b;
  }
        ...
        for (let Y = 0; Y < C.length; Y++) {
          ...
          w[W] && w[W].node.mode === z.mode
            ...
            : (w[W] && (w[W].lastCount = z.length),
              (v[W][D] =
                h(z.length, z.mode) + 4 + t.getCharCountIndicator(z.mode, b)));
        }
      }
      C = U;
    }
  ...
  (e.fromArray = function (b) {
    return b.reduce(function (w, v) {
      return (
        typeof v == "string"
          ? w.push(O(v, null))
          : v.data && w.push(O(v.data, v.mode)),
        w
      );
    }, []);
  }),
    (e.fromString = function (b, w) {
      const v = y(b, l.isKanjiModeEnabled()),
        C = g(v),
        S = f(C, w),
...
function Ai(e, t, o) {
  ...
  o.forEach(function (a) {
    n.put(a.mode.bit, 4),
      n.put(a.getLength(), yi.getCharCountIndicator(a.mode, e)),
      a.write(n);
  });
  const r = ye.getSymbolTotalCodewords(e),
...
function Oi(e, t, o) {
  const n = ye.getSymbolTotalCodewords(t),
    r = Ye.getTotalCodewordsCount(t, o),
    i = n - r,
    s = Ye.getBlocksCount(t, o),
    l = n % s,
    a = s - l,
    c = Math.floor(n / s),
    d = Math.floor(i / s),
  ...
  for (C = 0; C < h; C++) for (S = 0; S < s; S++) w[v++] = O[S][C];
  return w;
}
function Pi(e, t, o, n) {
  let r;
  if (Array.isArray(e)) r = Le.fromArray(e);
  else if (typeof e == "string") {
    let c = t;
    if (!c) {
      const d = Le.rawSplit(e);
      c = de.getBestVersionForData(d, o);
    }
    r = Le.fromString(e, c || 40);
  } else throw new Error("Invalid data");
  const i = de.getBestVersionForData(r, o);
  if (!i)
...
`
  ...
  return (
    ...
    t >= 7 && Ci(a, t),
    Ei(a, s),
    isNaN(n) && (n = qe.getBestMask(a, Ne.bind(null, a, o))),
    qe.applyMask(n, a),
    Ne(a, o, n),
    {
      modules: a,
...
pr.create = function (t, o) {
  ...
  return (
    typeof o < "u" &&
      ((n = De.from(o.errorCorrectionLevel, De.M)),
      (r = de.from(o.version)),
      (i = qe.from(o.maskPattern)),
      o.toSJISFunc && ye.setToSJISFunction(o.toSJISFunc)),
    Pi(t, r, n, i)
  );
};
var Or = {},
  ...
  (e.getOptions = function (n) {
    ...
    (e.qrToImageData = function (n, r, i) {
      const s = r.modules.size,
        ...
        d = i.margin * a,
        y = [i.color.light, i.color.dark];
      for (let h = 0; h < c; h++)
        for (let p = 0; p < c; p++) {
          let g = (h * c + p) * 4,
            f = i.color.light;
          if (h >= d && p >= d && h < c - d && p < c - d) {
            const O = Math.floor((h - d) / a),
              m = Math.floor((p - d) / a);
            f = y[l[O * s + m] ? 1 : 0];
          }
...
(function (e) {
  ...
  (e.render = function (i, s, l) {
    ...
    const d = t.getImageWidth(i.modules.size, a),
      y = c.getContext("2d"),
      h = y.createImageData(d, d);
    return (
      t.qrToImageData(h.data, i, a), o(y, c, d), y.putImageData(h, 0, 0), c
    );
  }),
...
Pr.render = function (t, o, n) {
  const r = Ii.getOptions(o),
    i = t.modules.size,
    s = t.modules.data,
    l = i + r.margin * 2,
    a = r.color.light.a
      ? "<path " +
        Vo(r.color.light, "fill") +
        ' d="M0 0h' +
        l +
        "v" +
        l +
...
function $o(e, t, o, n, r) {
  ...
  if (l) {
    ...
    return (
      s === 1
        ? ((o = t), (t = n = void 0))
        : s === 2 && !t.getContext && ((n = o), (o = t), (t = void 0)),
      new Promise(function (a, c) {
        try {
          const d = Ge.create(o, n);
          a(e(d, t, n));
        } catch (d) {
          c(d);
        }
...
qt.create = Ge.create;
qt.toCanvas = $o.bind(null, Ir.render);
qt.toDataURL = $o.bind(null, Ir.renderToDataURL);
qt.toString = $o.bind(null, function (e, t, o) {
  return Si.render(e, o);
});
var Ri = Object.defineProperty,
  ...
  Ko = (e, t, o) =>
    t in e
      ? Ri(e, t, { enumerable: !0, configurable: !0, writable: !0, value: o })
      : (e[t] = o),
  We = (e, t) => {
    for (var o in t || (t = {})) Di.call(t, o) && Ko(e, o, t[o]);
    if (Zo) for (var o of Zo(t)) Li.call(t, o) && Ko(e, o, t[o]);
    return e;
  };
function Ni() {
  var e;
  const t = (e = $t.state.themeMode) != null ? e : "dark",
    n = {
      light: {
        foreground: {
          1: "rgb(20,20,20)",
...
const A = {
    ...
    setTheme() {
      const e = document.querySelector(":root"),
        { themeVariables: t } = $t.state;
      if (e) {
        const o = We(We(We({}, Ni()), qo()), t);
  ...
  Bi = I`button{border-radius:var(--wcm-secondary-button-border-radius);height:28px;padding:0 10px;background-color:var(--wcm-accent-color)}button path{fill:var(--wcm-accent-fill-color)}button::after{border-radius:inherit;border:1px solid var(--wcm-color-overlay)}button:disabled::after{background-color:transparent}.wcm-icon-left svg{margin-right:5px}.wcm-icon-right svg{margin-left:5px}button:active::after{background-color:var(--wcm-color-overlay)}.wcm-ghost,.wcm-ghost:active::after,.wcm-outline{background-color:transparent}.wcm-ghost:active{opacity:.5}@media(hover:hover){button:hover::after{background-color:var(--wcm-color-overlay)}.wcm-ghost:hover::after{background-color:transparent}.wcm-ghost:hover{opacity:.5}}button:disabled{background-color:var(--wcm-color-bg-3);pointer-events:none}.wcm-ghost::after{border-color:transparent}.wcm-ghost path{fill:var(--wcm-color-fg-2)}.wcm-outline path{fill:var(--wcm-accent-color)}.wcm-outline:disabled{background-color:transparent;opacity:.5}`;
var Wi = Object.defineProperty,
  Ui = Object.getOwnPropertyDescriptor,
  Mt = (e, t, o, n) => {
    for (
      var r = n > 1 ? void 0 : n ? Ui(t, o) : t, i = e.length - 1, s;
      i >= 0;
      i--
    )
      (s = e[i]) && (r = (n ? s(t, o, r) : s(r)) || r);
...
let rt = class extends E {
  ...
  render() {
    ...
    return (
      ...
      u`<button class="${J(e)}" ?disabled="${this.disabled}" @click="${
        this.onClick
      }">${
        this.iconLeft
...
rt.styles = [A.globalCss, Bi];
Mt([_({ type: Boolean })], rt.prototype, "disabled", 2);
Mt([_()], rt.prototype, "iconLeft", 2);
Mt([_()], rt.prototype, "iconRight", 2);
Mt([_()], rt.prototype, "onClick", 2);
Mt([_()], rt.prototype, "variant", 2);
rt = Mt([P("wcm-button")], rt);
const ji = I`:host{display:inline-block}button{padding:0 15px 1px;height:40px;border-radius:var(--wcm-button-border-radius);color:var(--wcm-accent-fill-color);background-color:var(--wcm-accent-color)}button::after{content:'';top:0;bottom:0;left:0;right:0;position:absolute;background-color:transparent;border-radius:inherit;transition:background-color .2s ease;border:1px solid var(--wcm-color-overlay)}button:active::after{background-color:var(--wcm-color-overlay)}button:disabled{padding-bottom:0;background-color:var(--wcm-color-bg-3);color:var(--wcm-color-fg-3)}.wcm-secondary{color:var(--wcm-accent-color);background-color:transparent}.wcm-secondary::after{display:none}@media(hover:hover){button:hover::after{background-color:var(--wcm-color-overlay)}}`;
var ki = Object.defineProperty,
  Hi = Object.getOwnPropertyDescriptor,
  xo = (e, t, o, n) => {
    for (
      var r = n > 1 ? void 0 : n ? Hi(t, o) : t, i = e.length - 1, s;
      i >= 0;
      i--
    )
      (s = e[i]) && (r = (n ? s(t, o, r) : s(r)) || r);
...
let zt = class extends E {
  ...
  render() {
    ...
    return u`<button ?disabled="${this.disabled}" class="${J(
      e
    )}"><slot></slot></button>`;
  }
};
zt.styles = [A.globalCss, ji];
xo([_({ type: Boolean })], zt.prototype, "disabled", 2);
xo([_()], zt.prototype, "variant", 2);
zt = xo([P("wcm-button-big")], zt);
...
var Fi = Object.defineProperty,
  ...
  Zi = (e, t, o, n) => {
    for (
      var r = n > 1 ? void 0 : n ? Vi(t, o) : t, i = e.length - 1, s;
      i >= 0;
      i--
    )
      (s = e[i]) && (r = (n ? s(t, o, r) : s(r)) || r);
    return n && r && Fi(t, o, r), r;
  };
...
Je.styles = [A.globalCss, zi];
Je = Zi([P("wcm-info-footer")], Je);
const T = {
...
var qi = Object.defineProperty,
  ...
  Gi = (e, t, o, n) => {
    for (
      var r = n > 1 ? void 0 : n ? Yi(t, o) : t, i = e.length - 1, s;
      i >= 0;
      i--
    )
      (s = e[i]) && (r = (n ? s(t, o, r) : s(r)) || r);
    return n && r && qi(t, o, r), r;
  };
let Qe = class extends E {
  render() {
    return u`<div class="wcm-toolbar-placeholder"></div><div class="wcm-toolbar">${T.WALLET_CONNECT_LOGO} <button @click="${oe.close}">${T.CROSS_ICON}</button></div>`;
  }
};
Qe.styles = [A.globalCss, Ki];
Qe = Gi([P("wcm-modal-backcard")], Qe);
const Ji = I`main{padding:20px;padding-top:0;width:100%}`;
var Qi = Object.defineProperty,
  Xi = Object.getOwnPropertyDescriptor,
  ts = (e, t, o, n) => {
    for (
      var r = n > 1 ? void 0 : n ? Xi(t, o) : t, i = e.length - 1, s;
      i >= 0;
      i--
    )
      (s = e[i]) && (r = (n ? s(t, o, r) : s(r)) || r);
...
Xe.styles = [A.globalCss, Ji];
Xe = ts([P("wcm-modal-content")], Xe);
const es = I`footer{padding:10px;display:flex;flex-direction:column;align-items:inherit;justify-content:inherit;border-top:1px solid var(--wcm-color-bg-2)}`;
var os = Object.defineProperty,
  rs = Object.getOwnPropertyDescriptor,
  ns = (e, t, o, n) => {
    for (
      var r = n > 1 ? void 0 : n ? rs(t, o) : t, i = e.length - 1, s;
      i >= 0;
      i--
    )
      (s = e[i]) && (r = (n ? s(t, o, r) : s(r)) || r);
    return n && r && os(t, o, r), r;
  };
...
to.styles = [A.globalCss, es];
to = ns([P("wcm-modal-footer")], to);
const is = I`header{display:flex;justify-content:center;align-items:center;padding:20px;position:relative}.wcm-border{border-bottom:1px solid var(--wcm-color-bg-2);margin-bottom:20px}header button{padding:15px 20px}header button:active{opacity:.5}@media(hover:hover){header button:hover{opacity:.5}}.wcm-back-btn{position:absolute;left:0}.wcm-action-btn{position:absolute;right:0}path{fill:var(--wcm-accent-color)}`;
var ss = Object.defineProperty,
  ls = Object.getOwnPropertyDescriptor,
  Gt = (e, t, o, n) => {
    for (
      var r = n > 1 ? void 0 : n ? ls(t, o) : t, i = e.length - 1, s;
      i >= 0;
      i--
    )
      (s = e[i]) && (r = (n ? s(t, o, r) : s(r)) || r);
    return n && r && ss(t, o, r), r;
  };
let ft = class extends E {
  ...
  render() {
    const e = { "wcm-border": this.border },
      ...
      o = this.title
        ? u`<wcm-text variant="big-bold">${this.title}</wcm-text>`
        : u`<slot></slot>`;
    return u`<header class="${J(e)}">${
      t ? this.backBtnTemplate() : null
    } ${o} ${this.onAction ? this.actionBtnTemplate() : null}</header>`;
  }
};
ft.styles = [A.globalCss, is];
Gt([_()], ft.prototype, "title", 2);
Gt([_()], ft.prototype, "onAction", 2);
Gt([_()], ft.prototype, "actionIcon", 2);
Gt([_({ type: Boolean })], ft.prototype, "border", 2);
ft = Gt([P("wcm-modal-header")], ft);
const x = {
    ...
    getWalletIcon({ id: e, image_id: t }) {
      const { walletImages: o } = ht.state;
      return o != null && o[e] ? o[e] : t ? k.getWalletImageUrl(t) : "";
    },
    getWalletName(e, t = !1) {
    ...
    handleMobileLinking(e, t = "_self") {
      const { walletConnectUri: o } = Z.state,
        { mobile: n, name: r } = e,
      ...
      function l(a) {
        if (i) {
          const c = $.formatNativeUrl(i, a, r);
          $.openHref(c, t);
        } else if (s) {
          const c = $.formatUniversalUrl(s, a, r);
          $.openHref(c, t);
        }
      }
      o && l(o);
    ...
    handleAndroidLinking() {
      ...
      e &&
        ...
        $.openHref(e, $.isTelegram() ? "_blank" : "_self"));
    },
    async handleUriCopy() {
      const { walletConnectUri: e } = Z.state;
      if (e)
    ...
    openWalletExplorerUrl() {
      $.openHref(x.EXPLORER_WALLET_URL, "_blank");
    },
  ...
  as = I`.wcm-router{overflow:hidden;will-change:transform}.wcm-content{display:flex;flex-direction:column}`;
var cs = Object.defineProperty,
  ds = Object.getOwnPropertyDescriptor,
  _o = (e, t, o, n) => {
    for (
      var r = n > 1 ? void 0 : n ? ds(t, o) : t, i = e.length - 1, s;
      i >= 0;
      i--
    )
      (s = e[i]) && (r = (n ? s(t, o, r) : s(r)) || r);
    return n && r && cs(t, o, r), r;
  };
let Ft = class extends E {
  constructor() {
    super(),
...
Ft.styles = [A.globalCss, as];
_o([H()], Ft.prototype, "view", 2);
_o([H()], Ft.prototype, "prevView", 2);
Ft = _o([P("wcm-modal-router")], Ft);
const hs = I`div{height:36px;width:max-content;display:flex;justify-content:center;align-items:center;padding:9px 15px 11px;position:absolute;top:12px;box-shadow:0 6px 14px -6px rgba(10,16,31,.3),0 10px 32px -4px rgba(10,16,31,.15);z-index:2;left:50%;transform:translateX(-50%);pointer-events:none;backdrop-filter:blur(20px) saturate(1.8);-webkit-backdrop-filter:blur(20px) saturate(1.8);border-radius:var(--wcm-notification-border-radius);border:1px solid var(--wcm-color-overlay);background-color:var(--wcm-color-overlay)}svg{margin-right:5px}@-moz-document url-prefix(){div{background-color:var(--wcm-color-bg-3)}}.wcm-success path{fill:var(--wcm-accent-color)}.wcm-error path{fill:var(--wcm-error-color)}`;
var us = Object.defineProperty,
  ms = Object.getOwnPropertyDescriptor,
  Tr = (e, t, o, n) => {
    for (
      var r = n > 1 ? void 0 : n ? ms(t, o) : t, i = e.length - 1, s;
      i >= 0;
      i--
    )
      (s = e[i]) && (r = (n ? s(t, o, r) : s(r)) || r);
    return n && r && us(t, o, r), r;
  };
let he = class extends E {
  ...
  render() {
    ...
    return this.open
      ? u`<div class="${J(o)}">${t === "success" ? T.CHECKMARK_ICON : null} ${
          t === "error" ? T.CROSS_ICON : null
        }<wcm-text variant="small-regular">${e}</wcm-text></div>`
      : null;
  }
};
he.styles = [A.globalCss, hs];
Tr([H()], he.prototype, "open", 2);
he = Tr([P("wcm-modal-toast")], he);
const fs = 0.1,
  Yo = 2.5,
  G = 7;
function Ue(e, t, o) {
  return e === t ? !1 : (e - t < 0 ? t - e : e - t) <= o + fs;
}
function ps(e, t) {
  const o = Array.prototype.slice.call(
      qt.create(e, { errorCorrectionLevel: t }).modules.data,
      0
    ),
    n = Math.sqrt(o.length);
  return o.reduce(
    (r, i, s) => (s % n === 0 ? r.push([i]) : r[r.length - 1].push(i)) && r,
    []
  );
}
const gs = {
    generate(e, t, o) {
      ...
      a.forEach(({ x: g, y: f }) => {
        const O = (s.length - G) * l * g,
          m = (s.length - G) * l * f,
          b = 0.45;
        for (let w = 0; w < a.length; w += 1) {
          const v = l * (G - w * 2);
          i.push(
            L`<rect fill="${w % 2 === 0 ? n : r}" height="${v}" rx="${
              v * b
            }" ry="${v * b}" width="${v}" x="${O + l * w}" y="${m + l * w}">`
          );
        }
      });
      ...
      return (
        ...
        Object.entries(p)
          .map(([g, f]) => {
            const O = f.filter((m) => f.every((b) => !Ue(m, b, l)));
            return [Number(g), O];
          })
          .forEach(([g, f]) => {
            f.forEach((O) => {
              i.push(L`<circle cx="${g}" cy="${O}" fill="${n}" r="${l / Yo}">`);
            });
          }),
        Object.entries(p)
          .filter(([g, f]) => f.length > 1)
          .map(([g, f]) => {
            const O = f.filter((m) => f.some((b) => Ue(m, b, l)));
            return [Number(g), O];
          })
          .map(([g, f]) => {
            f.sort((m, b) => (m < b ? -1 : 1));
            const O = [];
            for (const m of f) {
              const b = O.find((w) => w.some((v) => Ue(m, v, l)));
              b ? b.push(m) : O.push([m]);
            }
            return [g, O.map((m) => [m[0], m[m.length - 1]])];
          })
          .forEach(([g, f]) => {
            f.forEach(([O, m]) => {
              i.push(
                L`<line x1="${g}" x2="${g}" y1="${O}" y2="${m}" stroke="${n}" stroke-width="${
                  l / (Yo / 2)
...
let nt = class extends E {
  ...
  svgTemplate() {
    const t = $t.state.themeMode === "light" ? this.size : this.size - 18 * 2;
    return L`<svg height="${t}" width="${t}">${gs.generate(
      this.uri,
      t,
      t / 4
    )}</svg>`;
  ...
  render() {
    const e = { "wcm-dark": $t.state.themeMode === "dark" };
    return u`<div style="${`width: ${this.size}px`}" class="${J(e)}">${
      this.walletId || this.imageUrl
        ? u`<wcm-wallet-image walletId="${j(this.walletId)}" imageId="${j(
            this.imageId
...
ue.styles = [A.globalCss, ys];
Mr([_()], ue.prototype, "onChange", 2);
ue = Mr([P("wcm-search-input")], ue);
const _s = I`@keyframes rotate{100%{transform:rotate(360deg)}}@keyframes dash{0%{stroke-dasharray:1,150;stroke-dashoffset:0}50%{stroke-dasharray:90,150;stroke-dashoffset:-35}100%{stroke-dasharray:90,150;stroke-dashoffset:-124}}svg{animation:rotate 2s linear infinite;display:flex;justify-content:center;align-items:center}svg circle{stroke-linecap:round;animation:dash 1.5s ease infinite;stroke:var(--wcm-accent-color)}`;
var Cs = Object.defineProperty,
  Es = Object.getOwnPropertyDescriptor,
  As = (e, t, o, n) => {
    for (
      var r = n > 1 ? void 0 : n ? Es(t, o) : t, i = e.length - 1, s;
      i >= 0;
      i--
    )
      (s = e[i]) && (r = (n ? s(t, o, r) : s(r)) || r);
...
Vt.styles = [A.globalCss, Os];
Co([_()], Vt.prototype, "variant", 2);
Co([_()], Vt.prototype, "color", 2);
Vt = Co([P("wcm-text")], Vt);
...
var Ms = Object.defineProperty,
  ...
  lt = (e, t, o, n) => {
    for (
      var r = n > 1 ? void 0 : n ? Ss(t, o) : t, i = e.length - 1, s;
      i >= 0;
      i--
    )
      (s = e[i]) && (r = (n ? s(t, o, r) : s(r)) || r);
    return n && r && Ms(t, o, r), r;
  };
let K = class extends E {
  ...
  sublabelTemplate() {
    return this.recent
      ? u`<wcm-text class="wcm-sublabel" variant="xsmall-bold" color="tertiary">RECENT</wcm-text>`
      : this.installed
      ? u`<wcm-text class="wcm-sublabel" variant="xsmall-bold" color="tertiary">INSTALLED</wcm-text>`
      : null;
  }
  handleClick() {
    Br.click({ name: "WALLET_BUTTON", walletId: this.walletId }),
      this.onClick();
  }
  render() {
    var e;
...
K.styles = [A.globalCss, Ts];
lt([_()], K.prototype, "onClick", 2);
lt([_()], K.prototype, "name", 2);
lt([_()], K.prototype, "walletId", 2);
lt([_()], K.prototype, "label", 2);
lt([_()], K.prototype, "imageId", 2);
lt([_({ type: Boolean })], K.prototype, "installed", 2);
lt([_({ type: Boolean })], K.prototype, "recent", 2);
K = lt([P("wcm-wallet-button")], K);
const Rs = I`:host{display:block}div{overflow:hidden;position:relative;border-radius:inherit;width:100%;height:100%;background-color:var(--wcm-color-overlay)}svg{position:relative;width:100%;height:100%}div::after{content:'';position:absolute;top:0;bottom:0;left:0;right:0;border-radius:inherit;border:1px solid var(--wcm-color-overlay)}div img{width:100%;height:100%;object-fit:cover;object-position:center}#wallet-placeholder-fill{fill:var(--wcm-color-bg-3)}#wallet-placeholder-dash{stroke:var(--wcm-color-overlay)}`;
...
let It = class extends E {
  ...
  render() {
    ...
    return u`${
      t.length
        ? u`<div><img crossorigin="anonymous" src="${t}" alt="${this.id}"></div>`
        : T.WALLET_PLACEHOLDER
    }`;
  }
};
It.styles = [A.globalCss, Rs];
$e([_()], It.prototype, "walletId", 2);
$e([_()], It.prototype, "imageId", 2);
$e([_()], It.prototype, "imageUrl", 2);
It = $e([P("wcm-wallet-image")], It);
...
Sr([H()], oo.prototype, "preload", 2);
oo = Sr([P("wcm-explorer-context")], oo);
var Ws = Object.defineProperty,
  Us = Object.getOwnPropertyDescriptor,
  js = (e, t, o, n) => {
    for (
      var r = n > 1 ? void 0 : n ? Us(t, o) : t, i = e.length - 1, s;
      i >= 0;
      i--
    )
      (s = e[i]) && (r = (n ? s(t, o, r) : s(r)) || r);
    return n && r && Ws(t, o, r), r;
  };
let Go = class extends E {
  constructor() {
    super(),
      ...
      A.setTheme(),
      (this.unsubscribeTheme = $t.subscribe(A.setTheme));
  }
  disconnectedCallback() {
    var e;
...
let ro = class extends E {
  ...
  render() {
    ...
    return u`<wcm-modal-header title="Connect your wallet" .onAction="${
      this.onGoToQrcode
    }" .actionIcon="${
      T.QRCODE_ICON
      ...
      return i
        ? u`<wcm-wallet-image walletId="${i.id}" imageId="${i.image_id}"></wcm-wallet-image>`
        : T.WALLET_PLACEHOLDER;
...
ro.styles = [A.globalCss, ks];
ro = Fs([P("wcm-android-wallet-selection")], ro);
...
var Zs = Object.defineProperty,
  ...
  Rt = (e, t, o, n) => {
    for (
      var r = n > 1 ? void 0 : n ? Ks(t, o) : t, i = e.length - 1, s;
      i >= 0;
      i--
    )
      (s = e[i]) && (r = (n ? s(t, o, r) : s(r)) || r);
    return n && r && Zs(t, o, r), r;
  };
let it = class extends E {
  constructor() {
    super(...arguments),
  ...
  svgLoaderTemplate() {
    ...
    const i =
      (t =
        (e = $t.state.themeVariables) == null
          ? void 0
          : e["--wcm-wallet-icon-large-border-radius"]) != null
        ? t
        : A.getPreset("--wcm-wallet-icon-large-border-radius");
    let s = 0;
    i.includes("%")
...
const yt = {
    manualWallets() {
      var e, t;
      const { mobileWallets: o, desktopWallets: n } = ht.state,
        r = (e = yt.recentWallet()) == null ? void 0 : e.id,
        i = $.isMobile() ? o : n,
        s = i == null ? void 0 : i.filter((l) => r !== l.id);
      return (t = $.isMobile()
        ? s == null
          ? void 0
    ...
    recomendedWallets(e = !1) {
      var t;
      const o = e || (t = yt.recentWallet()) == null ? void 0 : t.id,
        { recomendedWallets: n } = k.state;
      return n.filter((i) => o !== i.id);
    },
  },
  ot = {
    onConnecting(e) {
    ...
    manualWalletsTemplate() {
      return yt
        ...
        .map(
          (t) =>
            u`<wcm-wallet-button walletId="${t.id}" name="${
              t.name
    ...
    recomendedWalletsTemplate(e = !1) {
      return yt
        ...
        .map(
          (o) =>
            u`<wcm-wallet-button name="${o.name}" walletId="${o.id}" imageId="${
              o.image_id
            }" .onClick="${() => this.onConnecting(o)}"></wcm-wallet-button>`
        );
    },
    recentWalletTemplate() {
      const e = yt.recentWallet();
      if (e)
        return u`<wcm-wallet-button name="${e.name}" walletId="${
          e.id
...
var Ys = Object.defineProperty,
  ...
  Js = (e, t, o, n) => {
    for (
      var r = n > 1 ? void 0 : n ? Gs(t, o) : t, i = e.length - 1, s;
      i >= 0;
      i--
    )
      (s = e[i]) && (r = (n ? s(t, o, r) : s(r)) || r);
    return n && r && Ys(t, o, r), r;
  };
let no = class extends E {
  render() {
    const { explorerExcludedWalletIds: e, enableExplorer: t } = ht.state,
      o = e !== "ALL" && t,
      n = ot.manualWalletsTemplate(),
      r = ot.recomendedWalletsTemplate();
    let s = [ot.recentWalletTemplate(), ...n, ...r];
    s = s.filter(Boolean);
    const l = s.length > 4 || o;
    let a = [];
    l ? (a = s.slice(0, 3)) : (a = s);
    const c = !!a.length;
    return u`<wcm-modal-header .border="${!0}" title="Connect your wallet" .onAction="${
      x.handleUriCopy
    }" .actionIcon="${
      T.COPY_ICON
      ...
      c
        ? u`<wcm-modal-footer><div class="wcm-desktop-title">${
            T.DESKTOP_ICON
          }<wcm-text variant="small-regular" color="accent">Desktop</wcm-text></div><div class="wcm-grid">${a} ${
            l
              ? u`<wcm-view-all-wallets-button></wcm-view-all-wallets-button>`
              : null
...
no.styles = [A.globalCss, qs];
no = Js([P("wcm-desktop-wallet-selection")], no);
const Qs = I`div{background-color:var(--wcm-color-bg-2);padding:10px 20px 15px 20px;border-top:1px solid var(--wcm-color-bg-3);text-align:center}a{color:var(--wcm-accent-color);text-decoration:none;transition:opacity .2s ease-in-out;display:inline}a:active{opacity:.8}@media(hover:hover){a:hover{opacity:.8}}`;
var Xs = Object.defineProperty,
  tl = Object.getOwnPropertyDescriptor,
  el = (e, t, o, n) => {
    for (
      var r = n > 1 ? void 0 : n ? tl(t, o) : t, i = e.length - 1, s;
      i >= 0;
      i--
    )
      (s = e[i]) && (r = (n ? s(t, o, r) : s(r)) || r);
    return n && r && Xs(t, o, r), r;
  };
let io = class extends E {
  render() {
    const { termsOfServiceUrl: e, privacyPolicyUrl: t } = ht.state;
    return e ?? t
      ? u`<div><wcm-text variant="small-regular" color="secondary">By connecting your wallet to this app, you agree to the app's ${
          e
            ? u`<a href="${e}" target="_blank" rel="noopener noreferrer">Terms of Service</a>`
            : null
        } ${e && t ? "and" : null} ${
          t
            ? u`<a href="${t}" target="_blank" rel="noopener noreferrer">Privacy Policy</a>`
            : null
        }</wcm-text></div>`
      : null;
  }
};
io.styles = [A.globalCss, Qs];
io = el([P("wcm-legal-notice")], io);
...
var rl = Object.defineProperty,
  ...
  il = (e, t, o, n) => {
    for (
      var r = n > 1 ? void 0 : n ? nl(t, o) : t, i = e.length - 1, s;
      i >= 0;
      i--
    )
      (s = e[i]) && (r = (n ? s(t, o, r) : s(r)) || r);
    return n && r && rl(t, o, r), r;
  };
...
so.styles = [A.globalCss, ol];
so = il([P("wcm-mobile-wallet-selection")], so);
const sl = I`:host{all:initial}.wcm-overlay{top:0;bottom:0;left:0;right:0;position:fixed;z-index:var(--wcm-z-index);overflow:hidden;display:flex;justify-content:center;align-items:center;opacity:0;pointer-events:none;background-color:var(--wcm-overlay-background-color);backdrop-filter:var(--wcm-overlay-backdrop-filter)}@media(max-height:720px) and (orientation:landscape){.wcm-overlay{overflow:scroll;align-items:flex-start;padding:20px 0}}.wcm-active{pointer-events:auto}.wcm-container{position:relative;max-width:360px;width:100%;outline:0;border-radius:var(--wcm-background-border-radius) var(--wcm-background-border-radius) var(--wcm-container-border-radius) var(--wcm-container-border-radius);border:1px solid var(--wcm-color-overlay);overflow:hidden}.wcm-card{width:100%;position:relative;border-radius:var(--wcm-container-border-radius);overflow:hidden;box-shadow:0 6px 14px -6px rgba(10,16,31,.12),0 10px 32px -4px rgba(10,16,31,.1),0 0 0 1px var(--wcm-color-overlay);background-color:var(--wcm-color-bg-1);color:var(--wcm-color-fg-1)}@media(max-width:600px){.wcm-container{max-width:440px;border-radius:var(--wcm-background-border-radius) var(--wcm-background-border-radius) 0 0}.wcm-card{border-radius:var(--wcm-container-border-radius) var(--wcm-container-border-radius) 0 0}.wcm-overlay{align-items:flex-end}}@media(max-width:440px){.wcm-container{border:0}}`;
var ll = Object.defineProperty,
  al = Object.getOwnPropertyDescriptor,
  Eo = (e, t, o, n) => {
    for (
      var r = n > 1 ? void 0 : n ? al(t, o) : t, i = e.length - 1, s;
      i >= 0;
      i--
    )
      (s = e[i]) && (r = (n ? s(t, o, r) : s(r)) || r);
    return n && r && ll(t, o, r), r;
  };
let Zt = class extends E {
  constructor() {
    super(),
      ...
      (this.unsubscribeModal = oe.subscribe((e) => {
  ...
  onCloseModal(e) {
    e.target === e.currentTarget && oe.close();
  }
  onOpenModalEvent() {
    this.toggleBodyScroll(!1),
      ...
      setTimeout(async () => {
        const e = x.isMobileAnimation()
          ...
          o = 0.2;
        await Promise.all([
          dt(this.overlayEl, { opacity: [0, 1] }, { delay: t, duration: o })
            .finished,
          dt(this.containerEl, e, { delay: t, duration: o }).finished,
        ]),
          (this.active = !0);
      }, 0);
  }
  ...
  render() {
    ...
    return u`<wcm-explorer-context></wcm-explorer-context><wcm-theme-context></wcm-theme-context><div id="wcm-modal" class="${J(
      e
    )}" @click="${
      this.onCloseModal
    }" role="alertdialog" aria-modal="true"><div class="wcm-container" tabindex="0">${
      this.open
        ? u`<wcm-modal-backcard></wcm-modal-backcard><div class="wcm-card"><wcm-modal-router></wcm-modal-router><wcm-modal-toast></wcm-modal-toast></div>`
        : null
    }</div></div>`;
  }
};
Zt.styles = [A.globalCss, sl];
Eo([H()], Zt.prototype, "open", 2);
Eo([H()], Zt.prototype, "active", 2);
Zt = Eo([P("wcm-modal")], Zt);
const cl = I`div{display:flex;margin-top:15px}slot{display:inline-block;margin:0 5px}wcm-button{margin:0 5px}`;
var dl = Object.defineProperty,
  hl = Object.getOwnPropertyDescriptor,
  Jt = (e, t, o, n) => {
    for (
      var r = n > 1 ? void 0 : n ? hl(t, o) : t, i = e.length - 1, s;
      i >= 0;
      i--
    )
      (s = e[i]) && (r = (n ? s(t, o, r) : s(r)) || r);
    return n && r && dl(t, o, r), r;
  };
let pt = class extends E {
  ...
  render() {
    return u`<div>${this.isRetry ? u`<slot></slot>` : null} ${
      this.isMobile
        ? u`<wcm-button .onClick="${this.onMobile}" .iconLeft="${T.MOBILE_ICON}" variant="outline">Mobile</wcm-button>`
        : null
    } ${
      this.isDesktop
        ? u`<wcm-button .onClick="${this.onDesktop}" .iconLeft="${T.DESKTOP_ICON}" variant="outline">Desktop</wcm-button>`
        : null
    } ${
      this.isWeb
        ? u`<wcm-button .onClick="${this.onWeb}" .iconLeft="${T.GLOBE_ICON}" variant="outline">Web</wcm-button>`
        : null
    }</div>`;
  }
};
pt.styles = [A.globalCss, cl];
Jt([_({ type: Boolean })], pt.prototype, "isMobile", 2);
Jt([_({ type: Boolean })], pt.prototype, "isDesktop", 2);
Jt([_({ type: Boolean })], pt.prototype, "isWeb", 2);
Jt([_({ type: Boolean })], pt.prototype, "isRetry", 2);
pt = Jt([P("wcm-platform-selection")], pt);
const ul = I`button{display:flex;flex-direction:column;padding:5px 10px;border-radius:var(--wcm-button-hover-highlight-border-radius);height:100%;justify-content:flex-start}.wcm-icons{width:60px;height:60px;display:flex;flex-wrap:wrap;padding:7px;border-radius:var(--wcm-wallet-icon-border-radius);justify-content:space-between;align-items:center;margin-bottom:5px;background-color:var(--wcm-color-bg-2);box-shadow:inset 0 0 0 1px var(--wcm-color-overlay)}button:active{background-color:var(--wcm-color-overlay)}@media(hover:hover){button:hover{background-color:var(--wcm-color-overlay)}}.wcm-icons img{width:21px;height:21px;object-fit:cover;object-position:center;border-radius:calc(var(--wcm-wallet-icon-border-radius)/ 2);border:1px solid var(--wcm-color-overlay)}.wcm-icons svg{width:21px;height:21px}.wcm-icons img:nth-child(1),.wcm-icons img:nth-child(2),.wcm-icons svg:nth-child(1),.wcm-icons svg:nth-child(2){margin-bottom:4px}wcm-text{width:100%;text-align:center}#wallet-placeholder-fill{fill:var(--wcm-color-bg-3)}#wallet-placeholder-dash{stroke:var(--wcm-color-overlay)}`;
var ml = Object.defineProperty,
  fl = Object.getOwnPropertyDescriptor,
  pl = (e, t, o, n) => {
    for (
      var r = n > 1 ? void 0 : n ? fl(t, o) : t, i = e.length - 1, s;
      i >= 0;
      i--
    )
      (s = e[i]) && (r = (n ? s(t, o, r) : s(r)) || r);
    return n && r && ml(t, o, r), r;
  };
let lo = class extends E {
  onClick() {
  ...
  render() {
    ...
    return u`<button @click="${this.onClick}"><div class="wcm-icons">${o.map(
      (n) => {
        const r = x.getWalletIcon(n);
        if (r) return u`<img crossorigin="anonymous" src="${r}">`;
        const i = x.getWalletIcon({ id: n.id });
        return i
          ? u`<img crossorigin="anonymous" src="${i}">`
          : T.WALLET_PLACEHOLDER;
      }
...
lo.styles = [A.globalCss, ul];
lo = pl([P("wcm-view-all-wallets-button")], lo);
const gl = I`.wcm-qr-container{width:100%;display:flex;justify-content:center;align-items:center;aspect-ratio:1/1}`;
var wl = Object.defineProperty,
  vl = Object.getOwnPropertyDescriptor,
  xe = (e, t, o, n) => {
    for (
      var r = n > 1 ? void 0 : n ? vl(t, o) : t, i = e.length - 1, s;
      i >= 0;
      i--
    )
      (s = e[i]) && (r = (n ? s(t, o, r) : s(r)) || r);
    return n && r && wl(t, o, r), r;
  };
let Tt = class extends E {
  ...
  render() {
    return u`<div class="wcm-qr-container">${
      this.uri
        ? u`<wcm-qrcode size="${this.overlayEl.offsetWidth}" uri="${
            this.uri
          }" walletId="${j(this.walletId)}" imageId="${j(
            this.imageId
          )}"></wcm-qrcode>`
        : u`<wcm-spinner></wcm-spinner>`
    }</div>`;
  }
};
Tt.styles = [A.globalCss, gl];
xe([_()], Tt.prototype, "walletId", 2);
xe([_()], Tt.prototype, "imageId", 2);
xe([H()], Tt.prototype, "uri", 2);
Tt = xe([P("wcm-walletconnect-qr")], Tt);
var bl = Object.defineProperty,
  yl = Object.getOwnPropertyDescriptor,
  $l = (e, t, o, n) => {
    for (
      var r = n > 1 ? void 0 : n ? yl(t, o) : t, i = e.length - 1, s;
      i >= 0;
      i--
    )
      (s = e[i]) && (r = (n ? s(t, o, r) : s(r)) || r);
    return n && r && bl(t, o, r), r;
  };
let ao = class extends E {
  viewTemplate() {
    return $.isAndroid() && !$.isTelegram()
      ? u`<wcm-android-wallet-selection></wcm-android-wallet-selection>`
      : $.isMobile()
      ? u`<wcm-mobile-wallet-selection></wcm-mobile-wallet-selection>`
      : u`<wcm-desktop-wallet-selection></wcm-desktop-wallet-selection>`;
  }
  render() {
    return u`${this.viewTemplate()}<wcm-legal-notice></wcm-legal-notice>`;
  }
};
ao.styles = [A.globalCss];
ao = $l([P("wcm-connect-wallet-view")], ao);
const xl = I`wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}`;
var _l = Object.defineProperty,
  Cl = Object.getOwnPropertyDescriptor,
  Rr = (e, t, o, n) => {
    for (
      var r = n > 1 ? void 0 : n ? Cl(t, o) : t, i = e.length - 1, s;
      i >= 0;
      i--
    )
      (s = e[i]) && (r = (n ? s(t, o, r) : s(r)) || r);
    return n && r && _l(t, o, r), r;
  };
let me = class extends E {
  ...
  onFormatAndRedirect(e) {
    const { desktop: t, name: o } = $.getWalletRouterData(),
      ...
      r = t == null ? void 0 : t.universal;
    if (n) {
      const i = $.formatNativeUrl(n, e, o);
      $.openHref(i, "_self");
    } else if (r) {
      const i = $.formatUniversalUrl(r, e, o);
      $.openHref(i, "_blank");
    }
  }
  openDesktopApp() {
  ...
  render() {
    const { name: e, id: t, image_id: o } = $.getWalletRouterData(),
      { isMobile: n, isWeb: r } = x.getCachedRouterWalletPlatforms();
    return u`<wcm-modal-header title="${e}" .onAction="${
      x.handleUriCopy
    }" .actionIcon="${
      T.COPY_ICON
...
me.styles = [A.globalCss, xl];
Rr([H()], me.prototype, "isError", 2);
me = Rr([P("wcm-desktop-connecting-view")], me);
const El = I`wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}wcm-button{margin-top:15px}`;
var Al = Object.defineProperty,
  Ol = Object.getOwnPropertyDescriptor,
  Pl = (e, t, o, n) => {
    for (
      var r = n > 1 ? void 0 : n ? Ol(t, o) : t, i = e.length - 1, s;
      i >= 0;
      i--
    )
      (s = e[i]) && (r = (n ? s(t, o, r) : s(r)) || r);
    return n && r && Al(t, o, r), r;
  };
let co = class extends E {
  onInstall(e) {
    e && $.openHref(e, "_blank");
  }
  render() {
    ...
    return u`<wcm-modal-header title="${e}"></wcm-modal-header><wcm-modal-content><wcm-connector-waiting walletId="${t}" imageId="${j(
      o
...
let fe = class extends E {
  ...
  onFormatAndRedirect(e, t = !1) {
    const { mobile: o, name: n } = $.getWalletRouterData(),
      ...
      s = $.isTelegram() ? "_blank" : "_self";
    if (
      ((e = $.isTelegram() && $.isAndroid() ? encodeURIComponent(e) : e),
      r && !t)
    ) {
      const l = $.formatNativeUrl(r, e, n);
      $.openHref(l, s);
    } else if (i) {
      const l = $.formatUniversalUrl(i, e, n);
      $.openHref(l, s);
    }
  }
  openMobileApp(e = !1) {
    ...
    t && this.onFormatAndRedirect(t, e), x.setRecentWallet(o);
  }
  onGoToAppStore(e) {
    e && $.openHref(e, "_blank");
  }
  render() {
    ...
    return u`<wcm-modal-header title="${e}"></wcm-modal-header><wcm-modal-content><wcm-connector-waiting walletId="${t}" imageId="${j(
      ...
      l
        ? u`<wcm-text color="secondary" variant="small-thin">Still doesn't work? <span tabindex="0" @click="${() =>
...
fe.styles = [A.globalCss, Il];
Dr([H()], fe.prototype, "isError", 2);
fe = Dr([P("wcm-mobile-connecting-view")], fe);
const Sl = I`wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}`;
var Rl = Object.defineProperty,
  Dl = Object.getOwnPropertyDescriptor,
  Ll = (e, t, o, n) => {
    for (
      var r = n > 1 ? void 0 : n ? Dl(t, o) : t, i = e.length - 1, s;
      i >= 0;
      i--
    )
      (s = e[i]) && (r = (n ? s(t, o, r) : s(r)) || r);
...
let ho = class extends E {
  render() {
    const { name: e, id: t, image_id: o } = $.getWalletRouterData(),
      { isDesktop: n, isWeb: r } = x.getCachedRouterWalletPlatforms();
    return u`<wcm-modal-header title="${e}" .onAction="${
      x.handleUriCopy
    }" .actionIcon="${
      T.COPY_ICON
...
ho.styles = [A.globalCss, Sl];
ho = Ll([P("wcm-mobile-qr-connecting-view")], ho);
var Nl = Object.defineProperty,
  Bl = Object.getOwnPropertyDescriptor,
  Wl = (e, t, o, n) => {
    for (
      var r = n > 1 ? void 0 : n ? Bl(t, o) : t, i = e.length - 1, s;
      i >= 0;
      i--
    )
      (s = e[i]) && (r = (n ? s(t, o, r) : s(r)) || r);
    return n && r && Nl(t, o, r), r;
  };
let uo = class extends E {
  render() {
...
uo.styles = [A.globalCss];
uo = Wl([P("wcm-qrcode-view")], uo);
const Ul = I`wcm-modal-content{height:clamp(200px,60vh,600px);display:block;overflow:scroll;scrollbar-width:none;position:relative;margin-top:1px}.wcm-grid{display:grid;grid-template-columns:repeat(4,80px);justify-content:space-between;margin:-15px -10px;padding-top:20px}wcm-modal-content::after,wcm-modal-content::before{content:'';position:fixed;pointer-events:none;z-index:1;width:100%;height:20px;opacity:1}wcm-modal-content::before{box-shadow:0 -1px 0 0 var(--wcm-color-bg-1);background:linear-gradient(var(--wcm-color-bg-1),rgba(255,255,255,0))}wcm-modal-content::after{box-shadow:0 1px 0 0 var(--wcm-color-bg-1);background:linear-gradient(rgba(255,255,255,0),var(--wcm-color-bg-1));top:calc(100% - 20px)}wcm-modal-content::-webkit-scrollbar{display:none}.wcm-placeholder-block{display:flex;justify-content:center;align-items:center;height:100px;overflow:hidden}.wcm-empty,.wcm-loading{display:flex}.wcm-loading .wcm-placeholder-block{height:100%}.wcm-end-reached .wcm-placeholder-block{height:0;opacity:0}.wcm-empty .wcm-placeholder-block{opacity:1;height:100%}wcm-wallet-button{margin:calc((100% - 60px)/ 3) 0}`;
var jl = Object.defineProperty,
  kl = Object.getOwnPropertyDescriptor,
  Qt = (e, t, o, n) => {
    for (
      var r = n > 1 ? void 0 : n ? kl(t, o) : t, i = e.length - 1, s;
      i >= 0;
      i--
    )
      (s = e[i]) && (r = (n ? s(t, o, r) : s(r)) || r);
    return n && r && jl(t, o, r), r;
  };
const je = 40;
let gt = class extends E {
  ...
  isLastPage() {
    ...
    return n <= je || o.length >= n;
  }
  async fetchWallets() {
    var e;
    const { wallets: t, search: o } = k.state,
      { listings: n, total: r, page: i } = this.search ? o : t;
    if (!this.endReached && (this.firstFetch || (r > je && n.length < r)))
      try {
        this.loading = !0;
        const s = (e = Z.state.chains) == null ? void 0 : e.join(","),
          ...
          a = l.map((c) => x.getWalletIcon(c));
        await Promise.all([
          ...a.map(async (c) => x.preloadImage(c)),
          $.wait(300),
        ]),
          (this.endReached = this.isLastPage());
      } catch (s) {
        console.error(s), X.openToast(x.getErrorMessage(s), "error");
      } finally {
        (this.loading = !1), (this.firstFetch = !1);
      }
  }
  onConnect(e) {
    $.isAndroid() ? x.handleMobileLinking(e) : x.goToConnectingView(e);
  }
  onSearchChange(e) {
  ...
  render() {
    ...
    let i = ot.manualWalletsTemplate(),
      s = ot.recomendedWalletsTemplate(!0);
    r &&
      ((i = i.filter(({ values: c }) => x.caseSafeIncludes(c[0], this.search))),
      (s = s.filter(({ values: c }) => x.caseSafeIncludes(c[0], this.search))));
    const l = !this.loading && !o.length && !s.length,
      a = {
        "wcm-loading": n,
        "wcm-end-reached": this.endReached || !this.loading,
        "wcm-empty": l,
      };
    return u`<wcm-modal-header><wcm-search-input .onChange="${this.onSearchChange.bind(
      this
      ...
      n
        ...
        : o.map(
            (c) =>
              u`${
                c
                  ? u`<wcm-wallet-button imageId="${c.image_id}" name="${
                      c.name
      ...
      l
        ? u`<wcm-text variant="big-bold" color="secondary">No results found</wcm-text>`
        : null
    } ${
      !l && this.loading ? u`<wcm-spinner></wcm-spinner>` : null
    }</div></wcm-modal-content>`;
  }
};
gt.styles = [A.globalCss, Ul];
Qt([H()], gt.prototype, "loading", 2);
Qt([H()], gt.prototype, "firstFetch", 2);
Qt([H()], gt.prototype, "search", 2);
Qt([H()], gt.prototype, "endReached", 2);
gt = Qt([P("wcm-wallet-explorer-view")], gt);
const Hl = I`wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}`;
...
let pe = class extends E {
  ...
  render() {
    const { name: e, id: t, image_id: o } = $.getWalletRouterData(),
      { isMobile: n, isDesktop: r } = x.getCachedRouterWalletPlatforms(),
      i = $.isMobile();
    return u`<wcm-modal-header title="${e}" .onAction="${
      x.handleUriCopy
    }" .actionIcon="${
...
pe.styles = [A.globalCss, Hl];
Lr([H()], pe.prototype, "isError", 2);
pe = Lr([P("wcm-web-connecting-view")], pe);
